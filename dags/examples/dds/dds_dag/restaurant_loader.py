...
class RestaurantLoader:
    ...
    WF_KEY = "example_ordersystem_restaurants_stg_to_dds_workflow"
    ...
    def run_copy(self) -> int:
        ...
        with self.pg_dest.connection() as conn:
            ...
            load_queue = self.collection_loader.get_restaurant(last_loaded_ts, self._SESSION_LIMIT)
            ...
            i = 0
            for d in load_queue:
                self.pg_saver.save_restaurant(conn, str(d["restaurant_id"]), d["restaurant_name"], d["active_from"], d["active_to"])
