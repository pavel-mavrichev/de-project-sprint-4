...
class OrderLoader:
    ...
    WF_KEY = "example_ordersystem_orders_stg_to_dds_workflow"
    ...
    def run_copy(self) -> int:
        ...
        with self.pg_dest.connection() as conn:
            ...
            load_queue = self.collection_loader.get_order(last_loaded_ts, self._SESSION_LIMIT)
            ...
            for d in load_queue:
                ...
                if i % self._LOG_THRESHOLD == 0:
                    self.log.info(f"processed {i} documents of {len(load_queue)} while syncing ordeers.")
